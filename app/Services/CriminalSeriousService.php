    ...
    public function store($request)
    {
        ...
        if ($request->hasFile('incidentevedance')) {
            ...
            $file = $request->file('incidentevedance');
             ...
             $renamedFileName = "{$currentDate}_{$request->recordID}_1_{$request->arretedcrime}." . $file->getClientOriginalExtension();
             $file->storeAs('Evedances', $renamedFileName, 'public');
        }
        
          CrimeDetails::create([
            'Keywords' =>  $keywords,
            'arrested_crime_category' => 1,
