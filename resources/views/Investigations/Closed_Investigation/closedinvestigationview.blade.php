                                ...
                                <div class="tab-pane {{ $index === 1 ? 'active' : '' }}" id="tab{{ $index }}">
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            ...
                                            <input type="text" class="form-control" id="notetitle" name="notetitle"
                                                value="{{ $noteGroup->first()->investigation_title }}" disabled>
                                        </div>
                                        <div class="col-4">
                                            <label class="inputlabel">Date Of Investigation Note</label>
                                            <input type="date" class="form-control" id="notedate" name="notedate"
                                                value="{{ $noteGroup->first()->day_investigation_note }}" required>
                                        </div>
                                        <div class="col-4">
                                            <label class="inputlabel">Related Location</label>
                                            <input type="text" class="form-control" id="relatedlocation"
                                                value="{{ $noteGroup->first()->related_location }}"
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <textarea name="investigtionnote" id="investigtionnote" class="form-control"
                                                cols="20" rows="5">{{ $noteGroup->first()->description }}</textarea>
                                        </div>
                                    </div>
