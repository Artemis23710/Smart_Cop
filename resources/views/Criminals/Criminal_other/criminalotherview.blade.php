                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">      
                                            ...
                                            @endcan
                                            @can('Other-Crime_details-Delete')  
                            ...
                            <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">      
                                            @can('Other-Crime_Judgement-Edit')
                                            ...
                                            @endcan
                                            @can('Other-Crime_Judgement-Delete')
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    <form action="{{ route('criminalotherupdate') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
...
<div class="modal fade" id="judgementmodel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <hr style="width:100%; height:1px; background-color:#000;">
            <div class="modal-body">
                <form action="{{ route('criminalothercrimeverdictupdate') }}" method="POST">
                    @csrf
                    <br>
                    <div class="row">
