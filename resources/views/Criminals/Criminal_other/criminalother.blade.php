    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    <form action="{{ route('criminalotherstore') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
...
<div class="modal fade" id="judgementmodel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <hr style="width:100%; height:1px; background-color:#000;">
            <div class="modal-body">
                <form action="{{ route('criminalothercrimeverdict') }}" method="POST">
                    @csrf
                    <div class="row">
                ...
                <br>
                    <div class="row">
                        <div class="col-4 required">
                            <label class="inputlabel">Crime Record</label>
                            <select class="selectpicker" data-style="select-with-transition" title="Arrested Crime"
...
$(document).ready(function () {
    ...
    $("#othercrimelink").addClass('active');
                ...
                if (response.length > 0) {
                    $.each(response, function (key, value) {
                        $('#arrestedcrimelist').append(
                            '<option value="' + value.id + '" data-arrested-date="' + value.arrested_date + '" data-arrested-crime="' + value.arrested_crime + '">' + value.crime + ' - ' + value.incident_location + '</option>'
                        );
                    });
                } else {
