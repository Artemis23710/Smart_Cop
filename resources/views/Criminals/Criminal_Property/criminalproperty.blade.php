    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    <form action="{{ route('criminalpropertystore') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="modal-footer justify-content-center">
                            ...
                            @can('Financial-Crime_details-Add')
...
<div class="modal fade" id="judgementmodel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <hr style="width:100%; height:1px; background-color:#000;">
            <div class="modal-body">
                <form action="{{ route('criminalpropertycrimeverdict') }}" method="POST">
                    @csrf
                    <div class="row">
                ...
                <br>
                    ...
                    <div class="modal-footer justify-content-center">
                        ...
                        @can('Financial-Crime_Judgement-Add')
                        <button type="submit" name="btnsubmituser" id="btnsubmituser" class="btn btn-info">
